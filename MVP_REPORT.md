...
> 
> Seluruh antarmuka menggunakan *Card-based layout* (`border-slate-200`, `rounded-xl`), font modern `Plus Jakarta Sans`, **Logo Resmi SAKU IMM (`/public/logosakuimmnew.png`)**, Badge Co-Branding `SAKU IMM x BCA Syariah`, serta **Halaman Login 2-Grid Split-Screen dengan Interactive 3-Slide Feature Carousel Slider**.
